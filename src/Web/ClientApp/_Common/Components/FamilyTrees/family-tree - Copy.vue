    ...
    export default {
        ...
        methods: {
            refresh(parentElementId, data1) {
                ...
                vm.zoom = d3.zoom().on("zoom", _ => vm.g.attr("transform", d3.event.transform));
                ...
                vm.all_nodes.forEach(n => {
                    n.data = vm.data.persons[n.id] ? vm.data.persons[n.id] : vm.data.unions[n.id];
                ...
                root = vm.all_nodes.find(n => n.id == vm.data.start);
                root.visible = true;
            ...
            collapse: function (d) {
                ...
                var remove_inserted_root_nodes = n => {
                    ...
                    vm.dag.children = vm.dag.children.filter(c => !n.inserted_roots.includes(c));
            ...
            uncollapse: function (d, make_roots) {
                ...
                if (!make_roots) {
                    var add_root_nodes = n => {
                        ...
                        n.inserted_roots.forEach(p => vm.dag.children.push(p));
            ...
            update: function (source) {
                ...
                vm.dag = vm.tree(vm.dag);
                let nodes = vm.dag.descendants();
                let links = vm.dag.links();
                ...
                function click(d) {
                    ...
                    if (vm.is_extendable(d)) vm.uncollapse(d)
