            ...
            <b-overlay :show="busy">
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm">
                            <b-form-radio-group buttons button-variant="outline-primary" v-model="item.battleType" class="btn-block" v-bind:class="{'is-invalid':validations.get('battleType')}">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm">
                            <b-form-radio-group buttons button-variant="outline-primary" v-model="item.result" class="btn-block" v-bind:class="{'is-invalid':validations.get('result')}">
